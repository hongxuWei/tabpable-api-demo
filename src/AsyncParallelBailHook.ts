...
const NAME = 'AsyncParallelBailHook';
const log = debug(NAME);
const tapHook = new AsyncParallelBailHook();
const tapAsyncHook = new AsyncParallelBailHook();
const tapPromiseHook = new AsyncParallelBailHook();
const multiHook = new AsyncParallelBailHook();
